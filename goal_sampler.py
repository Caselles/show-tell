...
class GoalSampler:
    def __init__(self, args):
        ...
        self.init_stats(args.pedagogical_teacher)
    ...
    def init_stats(self, pedagogical_teacher):
        self.stats = dict()
        ...
        self.stats['epoch'] = []
        self.stats['total_nb_of_communications'] = []
        self.stats['episodes'] = []
        self.stats['global_sr'] = []
        self.stats['Pedagogical_SR'] = []
        self.stats['nb_discovered'] = []
        keys = ['goal_sampler', 'rollout', 'gs_update', 'store', 'norm_update',
                'policy_train', 'policy_train_bc', 'policy_train_sil', 'eval', 'epoch', 'total']
        for k in keys:
            self.stats['t_{}'.format(k)] = []

    def save(self, epoch, total_nb_of_communications, episode_count, av_res, av_rew, global_sr, time_dict, av_ped_rew):
        self.stats['epoch'].append(epoch)
        self.stats['total_nb_of_communications'].append(total_nb_of_communications)
        self.stats['episodes'].append(episode_count)
        self.stats['global_sr'].append(global_sr)
        self.stats['Pedagogical_SR'].append(av_ped_rew)
    ...
    def set_goal_sampler_for_fine_tuning(self):

        all_achievable_goals = generate_goals_demonstrator()

        self.discovered_goals = [np.array(x) for x in all_achievable_goals]

        self.discovered_goals_str = [str(x) for x in self.discovered_goals]
