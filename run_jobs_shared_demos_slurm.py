        ...
        for learner in learners:
            ...
            with open(job_file, 'w') as fh:
                ...
                if learner == 'pragmatic':
                    fh.writelines("srun python -u -B train_learner.py --cuda --shared-demos True --learner-from-demos True --teacher-mode {} --sqil True --pragmatic-learner True --compute-statistically-significant-results True --predictability True --reachability True --save-dir '{}/' 2>&1 ".format(teacher, job_directory + '/' + config))
                else:
                    fh.writelines("srun python -u -B train_learner.py --cuda --shared-demos True --learner-from-demos True --teacher-mode {} --sqil True --compute-statistically-significant-results True --predictability True --reachability True --save-dir '{}/' 2>&1 ".format(teacher, job_directory + '/' + config))
