...
if __name__ == '__main__':
	...
	path_save = '/media/gohu/backup_data/postdoc/show-tell/demos_datasets/'

	nb_demos = 1000

	demonstrator = 'pedagogical_teacher_1000'

	
	if demonstrator == 'naive_teacher_1000':
	...
	if demonstrator == 'pedagogical_teacher_1000':
