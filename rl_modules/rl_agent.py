...
from utils import id_to_language, generate_simple_goals_demonstrator
...
class RLAgent:
    ...
    def initialize_tell_policy(self, args):
        ...
        self.language_tools = TellPolicy(generate_simple_goals_demonstrator(), args.learner_language_mode)
