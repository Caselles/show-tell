...
def get_args():
    ...
    parser.add_argument('--teacher-action-mode', type=str, default='', help='Teacher can be naive or pedagogical')
    ...
    # language arguments
    parser.add_argument('--teacher-language-mode', type=str, default='', help='Teacher language mode (naive, shape/color preference, pedagogical.')
    parser.add_argument('--learner-language-mode', type=str, default='', help='Learner language mode (literal, pragmatic.')
    parser.add_argument('--no-biased-init', type=int, default=0, help='prevent biased environment initializations')
