...
teacher = TellPolicy(all_instructions_per_goal, agent_mode='naive')
...
teacher = TellPolicy(all_instructions_per_goal, agent_mode='shapes_preference')
...
teacher = TellPolicy(all_instructions_per_goal, agent_mode='colors_preference')
...
teacher = TellPolicy(all_instructions_per_goal, agent_mode='pedagogical')
...
teacher = TellPolicy(goals, agent_mode='naive')

from plots import *
visualize_all_instructions(teacher.all_instructions_per_goal)

path_save = '/home/gohu/workspace/postdoc/show-tell/gangstr_predicates_instructions/tell_policy/'

teacher = TellPolicy(goals, agent_mode='naive')
visualize_tell_policy(path_save, teacher.all_instructions_per_goal, teacher.tell_policy, teacher.agent_mode)

teacher = TellPolicy(goals, agent_mode='colors_preference')
visualize_tell_policy(path_save, teacher.all_instructions_per_goal, teacher.tell_policy, teacher.agent_mode)

teacher = TellPolicy(goals, agent_mode='shapes_preference')
visualize_tell_policy(path_save, teacher.all_instructions_per_goal, teacher.tell_policy, teacher.agent_mode)

teacher = TellPolicy(goals, agent_mode='pedagogical')
visualize_tell_policy(path_save, teacher.all_instructions_per_goal, teacher.tell_policy, teacher.agent_mode)'''
